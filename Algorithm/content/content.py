...
def content(survey_string, category_string):
    ...
    for pagerank_doc in pagerank_docs:
        ...
        result['new1'] = db.link.find_one({'_id':pagerank_doc['new1_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['new2'] = db.link.find_one({'_id':pagerank_doc['new2_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['top1'] = db.link.find_one({'_id':pagerank_doc['top1_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['top2'] = db.link.find_one({'_id':pagerank_doc['top2_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['top3'] = db.link.find_one({'_id':pagerank_doc['top3_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['top4'] = db.link.find_one({'_id':pagerank_doc['top4_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['top5'] = db.link.find_one({'_id':pagerank_doc['top5_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['ran1'] = db.link.find_one({'_id':pagerank_doc['ran1_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
        result['ran2'] = db.link.find_one({'_id':pagerank_doc['ran2_id']}, {'_id':0, 'title':1, 'url':1, 'hit':1})
