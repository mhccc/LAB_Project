...
def pagerank():
    keyword_title_list = ["남성", "여성", "청소년", "청년", "중년", "노년", "소식", "과식", "불규칙적 식사", "야식", "잦은 음주", "과음", "흡연", "유산소 운동부족", "유산소 운동과다", "무산소 운동부족", "무산소 운동과다",
                            "고혈압", "당뇨", "간암", "위암", "폐암", "갑상선암", "유방암", "기타암"]

    for keyword_title in keyword_title_list:
        try:
            print(keyword_title)
            ...
            try:
                ...
                print({'code' : 99, 'msg' : "No link"})
                return {'code' : 99, 'msg' : "No link"}
